...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
	  ...
	  array(
        'id'          => 'color_settings',
        'title'       => __( 'Color Settings', 'theme-text-domain' )
      ), 
	  array(
        'id'          => 'custom_settings',
    ...
    'settings'        => array( 
	   ...
	   array(
			'id'          => 'loginlogout',
			'label'       => __( 'Choose Option', 'theme-text-domain' ),
			'desc'        =>'Choose Option whether show Login / Logout in header main menu   ',
			'std'         => '',
			'type'        => 'radio',
			'section'     => 'header_settings',
			'choices'     => array( 
          ...
          array(
			...
			// end of log in log out
		  ),
	   
	    array(
		
			'id'          => 'header_social',
			'label'       => __( 'Header social links', 'theme-text-domain' ),
			'desc'        =>'Social links on header',
			'std'         => '',
			'type'        => 'list-item',
			'section'     => 'header_settings',
			'settings'    => array(
				...
				'id'          => 'icon_name',
				'label'          => 'Social Icon',
				'desc'          => 'use font awosome icon. not in clude fa ex:- facebook = facebook(not fa-facebook)',
				'std'          => '',
				'type'          => 'text',
				),
			array(
	   ...
	   array(
			...
			'desc'        =>' Copyright text on footer',
			'std'         => '© Moderna 2014 All right reserved. By Bootstraptaste',
			'type'        => 'textarea',
	   ...
	   array(
			'id'          => 'theme_color',
			'label'       => __( 'Set theme Color', 'theme-text-domain' ),
			'desc'        =>'Change color of theme',
			'std'         => '#eaeaea',
			'type'        => 'colorpicker',
	   ...
	   array(
			...
			'desc'        =>'Here you can change JS code',
			'std'         => '',
	   ...
	   array(
			'id'          => 'custom_css',
			'label'       => __( 'Custom js Code', 'theme-text-domain' ),
			'desc'        =>'Here you can change css code',
			'std'         => '',
			'type'        => 'css',
			'section'     => 'custom_settings',
